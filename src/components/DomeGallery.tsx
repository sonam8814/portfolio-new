...
const DEFAULT_IMAGES = [
  ...
  { src: 'https://avatars.githubusercontent.com/u/126733545?v=4', alt: 'Langchain' },
  { src: 'https://avatars.githubusercontent.com/u/126733545?v=4', alt: 'Langgraph' },
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  <img style={{ objectFit: 'contain' }} src={it.src} draggable={false} alt={it.alt} />
                  ...
                  <div className="absolute inset-x-0 bottom-2 flex justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                    <span className="bg-black/90 text-white text-[10px] sm:text-xs font-bold px-2 py-1 rounded-md tracking-widest uppercase backdrop-blur-sm border border-white/20">
                      {it.alt}
                    </span>
                  </div>
                </div>
